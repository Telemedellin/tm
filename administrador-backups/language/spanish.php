...
define("LM_TRANSFER_FTP_INCT_SUB","Intentará transferir los archivos por FTP en modo incremental para evitar páginas en blanco o timeouts.");
...
define("LM_DROPBOX_ACTIVATE","Activar");
...
define("LM_TRANSFER_URL_SUB","<small>Por favor, escriba la url de su sitio web donde se moverá la copia de seguridad. Ejemplo: http://www.nombresitio.com/ Esto se necesita para dirijirte allá y que accedas al script de restauración</small>");
...
Restaurar tus copias de seguridad nunca fué tan fácil! Con la ayuda de tu función de clonado de <a href='index2.php?option=com_cloner&task=view'>Ver copias</a>
...
<b>Atención:</b>
 ...
 2. Si olvidas tu contraseña necesitarás resetearla con este código: 
	...
	<b>$"."_CONFIG['jcpass'] = md5('mi_nueva_contraseña');");
?>