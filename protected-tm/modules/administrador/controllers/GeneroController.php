...
class GeneroController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index', 'view', 'crear', 'update', 'delete', 'asignar', 'desasignar'),
				'users'=>array('@'),
			),
	...
	public function actionAsignar()
	{
		...
		if(isset($_POST['MicrositioXGenero'])){
			$mxg->attributes = $_POST['MicrositioXGenero'];
			if($mxg->save()){
				Yii::app()->user->setFlash('success', 'El género ' . $mxg->genero->nombre . ' asignado con éxito');
				$this->redirect(Yii::app()->request->urlReferrer);
			}//if($genero->save())
