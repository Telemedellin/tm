	<div class="form-group">
        ...
        <?php echo $form->textField($contenido,'titulo',array('size'=>60,'maxlength'=>100, 'class' => 'form-control', 'required' => true)); ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <?php echo $form->numberField($contenido,'duracion',array('size'=>60,'maxlength'=>100, 'class' => 'form-control', 'required' => true)); ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <?php echo $form->numberField($contenido,'anio',array('size'=>60,'maxlength'=>100, 'class' => 'form-control', 'required' => true)); ?>
        </div>
