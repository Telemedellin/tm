<ul class="sidebar-menu">
	<li class="active">
        <a href="<?php echo bu('administrador') ?>">
            <i class="fa fa-dashboard"></i> <span>Panel de control</span>
        </a>
    </li>
    <?php if(Yii::app()->user->checkAccess('ver_novedades')): ?>
    <li>
        <a href="<?php echo bu('administrador/novedades') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/novedades/banners') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/guino') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/concursos') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/programacion') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/especiales') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/programas') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/documentales') ?>">
    ...
    <li>
        <a href="<?php echo bu('administrador/telemedellin') ?>">
    ...
    <li>
    	<a href="<?php echo bu('trivia/administracion') ?>">
