...
$config['AllowedAddresses'] = "*.clicktale.net, 75.125.82.64/26,50.97.162.64/26,82.80.23.217/32";
...
//$config['CacheLocation'] = "http://<telemede_clickt>:<5na@A;wk!zvT>@<localhost>:<3306>/<telemede_clickt>.<clicktale_track>";
