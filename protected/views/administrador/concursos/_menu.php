<?php if($menu): ?>
    ...
    <p>Este micrositio tiene asignado el menú <strong><?php echo $model->menu->nombre; ?></strong> <a href="<?php echo bu('administrador/concursos/desasignarmenu/' . $model->id) ?>"><small>Desasignar</small></a></p>
    <?php if($menu->getData()): ?>
