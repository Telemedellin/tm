...
<div id="micrositio">
	...
	<p>Si queréspegate una pasada por nuestros <?php echo l('programas', CHtml::normalizeUrl('programas')) ?> o nuestra <?php echo l('parrilla de programación', CHtml::normalizeUrl('programacion')) ?>.</p>
