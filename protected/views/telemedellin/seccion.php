...
<?php foreach($micrositios as $micrositio):?>
	<div <?php if($micrositio->destacado) echo 'class="destacado"'?> style="background: url('<?php echo bu() . $micrositio->background;?>') no-repeat center center; background-size: cover;">
