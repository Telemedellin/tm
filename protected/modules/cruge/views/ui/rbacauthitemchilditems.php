...
<?php 
$script = "
	jQuery('img.pin-on').each(function(){
		var img = jQuery(this);
		...
		img.click(function(){
			...
			var jsondata = '{ \"parent\": \"" . $model->name . "\" , \"child\": '
			...
			jQuery.ajax({
				...
				error: function(jqXHR, textStatus, errorThrown){
					//jQuery('#_errorResult').html('Ocurrio un error:<hr>'
						//+jqXHR.responseText);
					jQuery('#_errorResult').html('<p class=\'auth-item-error-msg\'>'
...
"; 
cs()->registerScript( 'crugeAuthItemChildItems', $script );
?>
