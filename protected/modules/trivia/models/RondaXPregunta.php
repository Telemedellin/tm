...
/**
 * This is the model class for table "ronda_x_pregunta".
 *
 * The followings are the available columns in table 'ronda_x_pregunta':
 * @property integer $id
 ...
 */
class RondaXPregunta extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RondaXPregunta the static model class
	 */
